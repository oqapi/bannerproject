...
CREATE TABLE client (id BIGINT AUTO_INCREMENT, client_text VARCHAR(255), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
