...
<div class="halfr">
<form method="post" id="bannergenerator" enctype="multipart/form-data" action="/frontend_dev.php/project/create">
...
<input type="text" maxlength="255" size="0" value="" name="standnumber">
</fieldset>
<button name="submit" type="submit">Generate your banners</button>
</form>
